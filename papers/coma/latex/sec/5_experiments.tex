...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{./images/loss.png}
...
\begin{table*}[t]
    ...
    \begin{tabular}{m{2cm} m{2cm} m{2cm} | m{2cm} m{2cm} m{2cm} | m{2cm}}
        ...
        &
        \centering\adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/context/313.png}}
        &
        \centering\adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/gt/313.png}}
        &
        \centering\adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/CoMa-2B/313.png}}
        &
        \centering\adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/CoMa-4B/313.png}}
        &
        \centering\adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/CoMa-8B/313.png}}
        &
        \adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/Qwen/313.png}} \\
        ...
        &
        \centering\adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/context/524.png}}
        &
        \centering\adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/gt/524.png}}
        &
        \centering\adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/CoMa-2B/524.png}}
        &
        \centering\adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/CoMa-4B/524.png}}
        &
        \centering\adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/CoMa-8B/524.png}}
        &
        \adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/Qwen/524.png}} \\
        ...
        &
        \centering\adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/context/8041.png}}
        &
        \centering\adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/gt/8041.png}}
        &
        \centering\adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/CoMa-2B/8041.png}}
        &
        \centering\adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/CoMa-4B/8041.png}}
        &
        \centering\adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/CoMa-8B/8041.png}}
        &
        \adjustbox{valign=c}{\includegraphics[width=1.9cm, frame]{./images/samples/Qwen/8041.png}} \\
